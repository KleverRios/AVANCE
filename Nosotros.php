...
<body class="contenedor">
    ...
    <section>
        ...
        <div class="container-card">
            <div class="card">
                <img src="imagenes/izquierda.jpg" alt="Logotipo de html5" >
            </div>
            <div class="card">
                <img src="imagenes/quienessomos.jpg.png" alt="Logotipo de html5" >
            </div>
            <div class="card">
                <img src="imagenes/derecha.jpg" alt="Logotipo de html5" >
            </div>
        </div>
    </section>
