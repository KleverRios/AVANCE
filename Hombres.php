...
<head>
    ...
    <link rel="stylesheet" href="estilohombres.css">
...
<body class="contenedor">
    ...
    <section class="contenido">
        <div class="mostrador" id="mostrador">
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        <img src="imagenes/hombre1.jpg" alt="">
                        <p class="descripcion"> NIKE RED</p>
                        <span class="precio">S/678</span><br>
                ...
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        ...
                        <span class="precio">S/700</span><br>
                ...
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        ...
                        <span class="precio">S/436</span><br>
            ...
            <div class="fila">
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        <img src="imagenes/hombre4.jpg" alt="">
                        <p class="descripcion"> Adidas Ported</p>
                        <span class="precio">S/799</span><br>
                ...
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        <img src="imagenes/hombre5.jpg" alt="">
                        <p class="descripcion">Cat Evolution</p>
                        <span class="precio">S/346</span><br>
                ...
                <div class="item" onclick="cargar(this)">
                    <div class="contenedor">
                        <img src="imagenes/hombre6.jpg" alt="">
                        <p class="descripcion"> Jordan Shiner</p>
                        <span class="precio">S/800</span><br>
    ...
    <script src="hombresfunciones.js"></script>
</body>
